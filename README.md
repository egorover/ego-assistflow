# 🤖 Ego-AssistFlow 
Проект, иеющий широкие мультимодальные возможности: текстовый и голосовый режимы, анализ и генерация изображений, работа с базой знаний


Telegram bot: @EgoSense | Мультимодальный ИИ
